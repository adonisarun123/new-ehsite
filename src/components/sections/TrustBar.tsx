...
const POINTS = [
  { icon: UserCheck, label: "Verified & background-checked" },
  { icon: HeartHandshake, label: "Trained, respectful caregivers" },
  { icon: ShieldCheck, label: "Safety-first daily care" },
  { icon: RefreshCw, label: "Replacement support" },
];
