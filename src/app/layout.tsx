  ...
  return (
    <html lang="en-IN">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@600;700;800&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body className="flex min-h-screen flex-col">
        ...
        <Header />
        <main id="main" className="flex-1 pb-16 xl:pb-0">
          {children}
        </main>
        <Footer />
        <StickyMobileCTA />
